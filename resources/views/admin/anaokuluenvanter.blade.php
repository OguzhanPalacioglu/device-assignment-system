<x-app-layout>
    <x-slot name="header">
        ANAOKULU ENVANTER LİSTESİ
    </x-slot>

    <div class="card mb-1">
        <div class="card-body">
            <div class="card-header text-center"><b>ANAOKULU ZİMMETTE OLMAYANLAR</b></div>
            <div class="m-2">
            ...
            Anaokulu Envanterinde Zimmette Olmayan Eşya Bulunamadı.
            @else
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-header text-center"><b>ANAOKULU ZİMMETLİ ENVANTER LİSTESİ</b></div>
            <table class="table table-striped table-bordered table-sm">
                <thead>
                    <tr>
                        <th scope="col">Ürünün Çeşidi</th>
