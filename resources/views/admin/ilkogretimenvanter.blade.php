<x-app-layout>
    <x-slot name="header">
        İLK-ORTAOKUL ENVANTER LİSTESİ
    </x-slot>

    <div class="card mb-1">
        <div class="card-body">
            <div class="card-header text-center"><b>İLK-ORTAOKUL ZİMMETTE OLMAYANLAR</b></div>
            <div class="m-2">
            ...
            İlk-Ortaokul Envanterinde Zimmette Olmayan Eşya Bulunamadı.
            @else
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-header text-center"><b>İLK-ORTAOKUL ZİMMETLİ ENVANTER LİSTESİ</b></div>
            <table class="table table-striped table-bordered table-sm">
                <thead>
                    <tr>
                        <th scope="col">Ürünün Çeşidi</th>
